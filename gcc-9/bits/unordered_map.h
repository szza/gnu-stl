...
_GLIBCXX_BEGIN_NAMESPACE_CONTAINER
    ...
    using __umap_traits = __detail::_Hashtable_traits<_Cache, false, true>; // 对于 unordered_map 第三个参数是 true
    ...
    template<bool _Cache>
    using __ummap_traits = __detail::_Hashtable_traits<_Cache, false, false>; // 对于 unordered_multimap 第三个参数是 true
