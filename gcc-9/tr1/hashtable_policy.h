...
namespace __detail
{
  ...
  template<typename _Value, bool __cache>
    ...
    {
      _Hashtable_iterator_base(_Hash_node<_Value, __cache>* __node, Hash_node<_Value, __cache>** __bucket)
  ...
  _Prime_rehash_policy::_M_need_rehash(std::size_t __n_bkt, std::size_t __n_elt, std::size_t __n_ins) const
  {
    if (__n_elt + __n_ins > _M_next_resize)
    {
        ...
        {
            _M_next_resize = static_cast<std::size_t>(__builtin_ceil(__n_bkt * _M_max_load_factor));
  ...
  template<typename _Key, typename _Value,
    ...
    protected:
      ...
      bool
      _M_compare(const _Key& __k, _Hash_code_type, _Hash_node<_Value, false>* __n) const
  ...
  template<typename _Key, 
    ...
    protected:
      ...
      bool
      _M_compare(const _Key& __k, _Hash_code_type __c, _Hash_node<_Value, true>* __n) const
